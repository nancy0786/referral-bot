...
async def resolve_chat_id(context: ContextTypes.DEFAULT_TYPE, chat_identifier: str):
    ...
    try:
        ...
        # Handle username (e.g., @myprivatechannel) or t.me link (e.g., t.me/myprivatechannel)
        if chat_identifier.startswith("@") or chat_identifier.startswith("t.me/"):
        ...
        if chat_identifier.startswith("t.me/+") or chat_identifier.startswith("+"):
            invite_code = chat_identifier.split("+")[-1]
